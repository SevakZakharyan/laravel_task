                ...
                <div class="container-fluid">
                    ...
                    <!-- Content Row -->
                        ...
                        <!-- Content Row -->
                                ...
                                <div>
                                    <form action="{{url('app/chart/filter')}}" method="POST">
                                    @csrf
                                        <label for="Question">Select Question</label>
                                        <select name="question" id="Question">

                                        @foreach($questions as $question)
                                            <option name="question_id" value="{{$question->id}}">{{$question->question}}</option>
                                        @endforeach
                                        </select>
                                        <br>From <input id="date" name="date_from" type="date"><br>
                                        <br>To <input id="date" name="date_to" type="date"><br>
